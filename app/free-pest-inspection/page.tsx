      ...
      <section className="bg-[#1A7A4C] text-white py-16 px-4" aria-label="Hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">
            Free Pest Inspection — Suffolk County, Nassau County &amp; Queens
          </h1>
          <p className="text-lg text-green-100 mb-8 max-w-2xl mx-auto">
            Get a free, no-obligation pest inspection anywhere across Long Island or Queens. Our licensed technicians find problems before they escalate.
          </p>
